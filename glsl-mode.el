...
(defconst glsl-font-lock-keywords-1
  (list
   ;; Preprocessor
   '("#[[:space:]]*[[:alpha:]][[:alnum:]]*" . font-lock-preprocessor-face)
   ;; Keywords
